...
struct Node NodeInfo[600];
int N_POINT_COUNT=0;//节点个数
//int IncludingNode_num = 0;
//int OpResultNode_num;
//int Back_num ;
double g_Trial[600][600]; //两两城市间信息素，就是环境信息素
double g_Trial_Init[600][600];
//double g_Cost[600][600];
int g_Cost[600][600];
//double g_Cost_One[600][600];
//int OpResultNode[600];
int N_POINT_NO[600];
int N_POINT_SELF_ID[600];
...
int readfile(const char * const filename1,const char * const filename2)
{
    ...
    const char *split = "|";
    char *buf1 = new char[600];
    char *buf2 = new char[600];
    char *buf3 = new char[600];
    char *buf4 = new char[600];
    char *buf5 = new char[600];
    int *buf6 = new int[600];
