...
{
int SelfNodeID;
int NeighborNodeID[300];
};

extern struct Topology topology[5000];
//struct Routeinfo routeinfo;
extern struct Node NodeInfo[300];
extern int N_POINT_COUNT;//节点个数
 //int IncludingNode_num = 0;
 //int OpResultNode_num;
 //int Back_num ;
 extern double g_Trial[300][300]; //两两城市间信息素，就是环境信息素
 //double g_Cost[600][600];
 extern int g_Cost[300][300];
 //int OpResultNode[600];
extern int N_POINT_NO[300];
extern int N_POINT_SELF_ID[300];
